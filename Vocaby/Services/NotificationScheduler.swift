...
struct NotificationScheduler {
    static let dailyReminderIdentifier = "vocaby.daily-reminder"
    static let deepLinkUserInfoKey = "vocaby.internal-url"
    static let dailyReminderURL = URL(string: "vocaby://today")!
